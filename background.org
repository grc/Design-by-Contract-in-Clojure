...
definition in a module exports section \cite{racket}. Needed as
contracts are enforced at calls between modules only and (they claim)
classes can flow over those boundary.
