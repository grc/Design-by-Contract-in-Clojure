...
We have chosen to use Clojure as the basis for our investigation in to
...
#+latex: \begin{listing}[H]
#+latex: \caption{caption} \label{lst:source-loc}
#+srcname: label
#+begin_src clojure :tangle yes :exports code
...
#+latex: \begin{listing}\label{lst:contract-failure}
#+begin_src clojure :tangle yes :exports code
...
We could use different implementations of =contract-error= to generate
...
formal studies into this, a widely heard response
\cite{http://the-dusty-deck.blogspot.co.uk/2011/08/why-dont-you-use-design-by-contract.html},
\cite{irc-clojure} combine the difficulty of elucidating whilst creating
a function and the difficulty in then reusing or refactoring this
constrained code. An extreme example of this is the Ariane 5 rocket
...
The enquiry into the failure
recommended\cite{}
#qHP://www.di.unito.it/~damiani/ariane5rep.html}:
...
and justifications could be readily seen.  But the prebolem of keeping
