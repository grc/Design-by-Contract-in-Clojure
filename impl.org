...
#+LATEX_HEADER: \usepackage{hyperref} \usepackage{inconsolata}



# NOT IN USE LaTeX_HEADER: \usemintedstyle{bw}
#+LaTeX_HEADER: \newminted{clojure}{fontsize=\huge,linenos}
...
TODO this predicate is used in faulty-sqrt, earlier.
...
then executed at run time.  A full explanation of macros is beyond the
scope of this dissertation, \cite{Seibel} is recommended as a starting point.
...
TODO - This is in the wrong palce!
...
trace can only be generated at run time
